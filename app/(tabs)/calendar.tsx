...
export default function CalendarScreen() {
  ...
  const styles = useThemedStyles((c) => ({
    ...
    modeChipActive: { backgroundColor: c.selectedFill, borderColor: c.selectedFill },
    ...
    dayCardActive: { backgroundColor: c.selectedFill, borderColor: c.selectedFill },
    ...
    monthCellActive: { backgroundColor: c.selectedFill },
